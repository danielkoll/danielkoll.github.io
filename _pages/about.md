...
I originally grew up in Tanzania, Germany, and Kenya. I went on to study Physics and Philosophy at Harvard, and did a PhD in climate science and extrasolar planets at the University of Chicago. After that I was a postdoc at MIT, supported by a fellowship from the James S. McDonnell Foundation. I now work at Peking University in Beijing, China. I also serve on the Scientific Advisory Committee of the [Rocky Worlds DDT](https://rockyworlds.stsci.edu), a large 500 hour program on the James Webb Space Telescope that is using the secondary eclipse photometry method my collaborators and I developed ([1](https://iopscience.iop.org/article/10.3847/1538-4357/ab4c91),[2](https://iopscience.iop.org/article/10.3847/1538-4357/ab4c90),[3](https://iopscience.iop.org/article/10.3847/1538-4357/ab4a05)) to search nearby rocky exoplanets for signs of an atmosphere.

Why do different planets have such different climates? My work tries to explore this question from a range of angles. Highlights include ancient climates on Earth, atmospheric dynamics of rocky exoplanets, how to hunt for rocky exoplanet atmospheres, how to characterize rocky exoplanets without atmospheres, habitability of 'exotic' planets such as White Dwarf planets and Hycean worlds, and fundamental aspects of Earth's radiative balance and radiative feedbacks. Find out more about our group's research [here](https://danielkoll.github.io/publications).
...
<!-- .... --><!-- .... -->
	<li>
	<em>February 2026</em>
    	Why do climate models consistely show that an instantaneous increase in CO2 abruptly decreases rainfall (before the surface eventually warms, pushing rainfall back up)?  Our answer in a <a href="https://eartharxiv.org/repository/view/8210/">new study</a> led by Yue Xu is that CO2 affects Earth's surface budget differently than its top-of-atmosphere (TOA) budget. By deriving an analytic model for CO2's surface forcing, and combining it with a previous analytic model for the TOA forcing, we show that CO2 supresses the TOA more than the surface budget. This decreases the atmosphere's latent heating and suppresses rainfall. Importantly, CO2's precipitation effect is state-dependent: the same CO2 doubling affects precipitation differently in a cold versus a hot climate, adding new nuance to our understanding of how CO2 affects Earth's climate.
	</li>
<!-- .... -->
		<!-- .... -->
	<li>
	<em>December 2025</em>
    	I gave a PKU Gezhi Forum public lecture on rocky exoplanets, what we've learned about these planets so far, and what the results might tell us in the search for life elsewhere. You can find the lecture recording <a href="https://www.koushare.com/live/details/48739">here</a>.
	</li>
<!-- .... -->
<!-- .... -->
	<li>
